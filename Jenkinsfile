...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/atmega16-zero-cross-detector-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/atmega16-zero-cross-detector-studio.git'
